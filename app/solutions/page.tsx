    ...
    return (
        <div className="fixed bottom-10 right-10 z-[200]">
            ...
            >
                ...
                <div className="relative z-10 text-gray-900 drop-shadow-sm flex flex-col items-center">
                    <BrainCircuit className="w-12 h-12 stroke-[1.2] group-hover:text-indigo-600 transition-colors" />
                </div>
