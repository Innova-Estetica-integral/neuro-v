                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
                        ...
                        >
                            ...
                            <p className="text-lg sm:text-xl text-indigo-100/60 font-medium leading-relaxed max-w-xl mx-0">
                                Donna toma el control de tu WhatsApp y mensajería de alta demanda con eficiencia operativa. Mientras ella cualifica, agenda y cierra citas, tú te enfocas en entregar la máxima excelencia médica en tu consulta sin interrupciones.
                            </p>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-4">
                                {[
                                    { t: "Perfil del Paciente", d: "Entendemos la necesidad del paciente desde el primer contacto." },
                                    { t: "Crecimiento Estratégico", d: "Difusión sincronizada con tu agenda y rentabilidad." },
                                    { t: "Asistente de Crecimiento", d: "Un sistema de apoyo constante que no deja escapar ni un solo contacto." }
                                ].map((item, i) => (
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 sm:gap-20 items-center">
                        <div className="text-left space-y-8">
                            ...
                            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-[1000] tracking-tightest leading-tight">
                                Tu marca <br /><span className="text-indigo-600">en el radar 24/7.</span>
                            </h2>
                            <p className="text-lg sm:text-xl text-gray-500 font-medium mt-6 sm:mt-8 leading-relaxed max-w-xl mx-0">
                                Sistema orquestado para que tu clínica esté siempre presente para tus pacientes. Donna apoya cada canal para asegurar tu visibilidad.
                            </p>

                            <div className="grid gap-6 mt-10 sm:mt-12">
                                {[
                                    { title: "Difusión & Contacto en Redes", desc: "Donna apoya tus campañas y automatiza comunicaciones personalizadas con segmentación estratégica.", tag: "Social Ads", icon: TrendingUp, color: "bg-indigo-100", textColor: "text-indigo-600", tagBg: "bg-indigo-50" },
                                    { title: "Procesos de Cita 24/7", desc: "Rellenado de espacios libres en agenda y contacto con pacientes de forma proactiva.", tag: "Gestión", icon: Target, color: "bg-emerald-100", textColor: "text-emerald-600", tagBg: "bg-emerald-50" },
                                    { title: "Recuperación de Agenda", desc: "Detección proactiva de cancelaciones y activación de avisos para maximizar la ocupación.", tag: "Eficiencia", icon: Zap, color: "bg-amber-100", textColor: "text-amber-600", tagBg: "bg-amber-50" }
                                ].map((item, i) => (
                                    <motion.div
                                        key={i}
                                        whileHover={{ y: -5, scale: 1.01 }}
            ...
            <section id="precios" className="py-20 sm:py-24 px-6 sm:px-12 bg-white relative overflow-hidden">
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-left mb-12 sm:mb-20 space-y-8">
                        ...
                        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tightest leading-tight mb-6 text-gray-900">
                            NeuroV te ayuda <span className="text-indigo-600">con todo.</span>
                        </h2>
                        <p className="text-gray-500 text-lg font-medium max-w-2xl mx-0">
                    ...
                    >
                        ...
                        <div className="relative z-10 space-y-8 sm:space-y-10">
                            <h2 className="text-4xl sm:text-7xl lg:text-9xl font-[1000] mb-8 sm:mb-12 tracking-tightest leading-[0.9] italic">
                                Tú te enfocas en el paciente. <br />Nosotros <span className="underline decoration-4 sm:decoration-8 decoration-white/30">del resto.</span>
                            </h2>
                            <p className="text-2xl sm:text-3xl font-bold max-w-2xl mx-0 text-gray-800 opacity-80 mb-12">
                                Recupera tu tiempo, profesionaliza tu gestión clínica y permite que Donna se encargue de la operativa 24/7.
                            </p>
                            <motion.button
