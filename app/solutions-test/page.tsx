...
const DonnaFloatingAssistant = () => {
    ...
    const [chat, setChat] = useState<{ role: 'donna', content: string, options?: string[] }>({
        role: 'donna',
        content: "Hola, soy tu asistente operativa en NeuroV. Juntos simplificaremos la gestión de tu consulta. ¿Empezamos?",
        options: ['SÍ, EMPEZAR']
    });
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="relative z-10 flex justify-center mb-6">
                                <span className="text-[8px] font-black text-indigo-400/60 uppercase tracking-[0.5em]">Apoyo Operativo // NeuroV</span>
                            </div>
...
export default function SolutionsTest() {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-900 selection:bg-indigo-100 selection:text-indigo-900 overflow-x-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="grid lg:grid-cols-5 gap-10 sm:gap-16 items-center">
                        <div className="lg:col-span-3 text-left">
                            ...
                            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black leading-[1.1] mb-10 tracking-tightest text-white">
            ...
            <div className="pt-14 pb-12 bg-gray-50/50 border-y border-gray-100 overflow-hidden relative">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
                        ...
                        >
                            <div className="w-full flex justify-center lg:justify-start mb-8">
                                <div className="flex sm:inline-flex items-center justify-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-white/5 border border-white/10 text-indigo-400 text-[clamp(9px,2.5vw,10px)] font-bold uppercase tracking-[0.1em] whitespace-nowrap w-full sm:w-auto">
                                    <BrainCircuit size={10} className="w-[14px] h-[14px]" /> ASISTENCIA OPERATIVA 24/7
                                </div>
                            </div>
                            ...
                            <p className="text-lg sm:text-xl text-slate-300 font-medium leading-relaxed max-w-xl mx-0">
                                Donna toma el control de tu WhatsApp y mensajería de alta demanda con <span className="text-indigo-400">eficiencia operativa</span>. Mientras ella cualifica, agenda y cierra citas, tú te enfocas en entregar la <span className="text-white font-bold">máxima excelencia médica</span> en tu consulta sin interrupciones.
                            </p>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid lg:grid-cols-2 gap-2 lg:gap-20 items-center">
                        <div className="text-left space-y-8">
                            ...
                            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-[1000] tracking-tightest leading-tight text-slate-900 [text-wrap:balance]">
                            ...
                            <p className="text-slate-600 text-sm sm:text-lg leading-relaxed font-medium mb-6 sm:mb-10 max-w-xl mx-0">
                                Integra NeuroV con las <span className="text-indigo-600 font-bold">plataformas líderes en Chile.</span> Automatiza la venta de bonos I-Med, gestiona boletas del SII y centraliza la administración de tu equipo con Buk en un solo lugar.
                            </p>
                            ...
                            <div className="grid gap-4">
                                {[
                                    ...
                                    <motion.div
                                        ...
                                        className="flex gap-4 p-4 rounded-3xl bg-gray-50/50 border border-transparent hover:border-indigo-100 hover:bg-white hover:shadow-xl transition-all group cursor-default"
                                    >
                                        <div className={`w-10 h-10 bg-indigo-600/10 rounded-2xl flex items-center justify-center text-indigo-600 group-hover:scale-110 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-500 shadow-sm shrink-0`}>
                                            <item.icon size={20} />
                                        </div>
                                        <div>
                                            <div className="flex items-center gap-3 mb-1">
                                                <h4 className="text-sm font-black uppercase tracking-tight text-gray-900 leading-tight italic uppercase">{item.title}</h4>
                                                <span className={`text-[8px] font-black text-indigo-600 bg-indigo-50 px-2 py-1 rounded-full uppercase shrink-0 whitespace-nowrap`}>{item.tag}</span>
                                            </div>
                        ...
                        <div className="relative overflow-visible">
                            <div className="aspect-square flex items-center justify-center relative rounded-[3rem] overflow-hidden border-2 border-indigo-200/50 shadow-[0_30px_80px_-20px_rgba(79,70,229,0.35)]">
                                ...
                                <div className="absolute inset-0 z-0">
                                    ...
                                    {/* Swirl Effect Removed per user request */}
                                </div>
                                <style>{`
                                            ...
                                            <div className="absolute -translate-x-1/2 -translate-y-1/2 w-24 h-24 sm:w-48 sm:h-48 flex items-center justify-center opacity-80 hover:opacity-100 transition-all duration-500">
                                                <img
                                                    ...
                                                    className={`${orb.logo.includes('Google_Ads') ? 'w-[53.2px] h-[53.2px] sm:w-[91.2px] sm:h-[91.2px]' :
                                                        orb.logo.includes('meta') ? 'w-[65px] h-[65px] sm:w-[156px] sm:h-[156px]' :
                ...
                <div className="max-w-7xl mx-auto relative">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        >
                            <div className="w-full flex justify-center lg:justify-start mb-8">
                                <div className="flex sm:inline-flex items-center justify-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-600 text-[clamp(9px,2.5vw,10px)] font-bold uppercase tracking-[0.1em] whitespace-nowrap w-full sm:w-auto">
                                    <Target size={10} className="w-[14px] h-[14px]" /> TU VENTANA AL MUNDO
                                </div>
                            </div>
                            ...
                            <p className="text-lg sm:text-xl text-gray-500 font-medium leading-relaxed max-w-xl mx-0">
                                Transformamos tu presencia digital en un proceso de atención y crecimiento, optimizado para rastrear cada intención de compra. Donna analiza el comportamiento del paciente para convertir visitas en citas de alto valor de forma automática.
                            </p>
                                ...
                                {[
                                    {
                                        ...
                                        desc: "Entendemos lo que busca tu paciente desde el primer clic.",
                                        tag: "Segmentación",
                                        color: "indigo"
                                    },
                                    {
                                        icon: TrendingUp,
                                        title: "MÁS PACIENTES",
                                        desc: "Atrae pacientes de forma ordenada según tu disponibilidad real.",
                                        tag: "Crecimiento",
                                        color: "emerald"
                                    },
                                    {
                                        ...
                                        desc: "Un asistente que está siempre ahí para que no pierdas ningún contacto.",
                                        tag: "Donna AI",
                                        color: "violet"
                                    }
                                ].map((item, i) => (
                                    <motion.div
                                        ...
                                        className="group relative flex gap-6 p-8 rounded-[2.5rem] bg-gray-50/40 border border-transparent hover:bg-white hover:border-indigo-100/50 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.08)] transition-all duration-500 cursor-default"
                                    >
                                        <div className={`w-16 h-16 rounded-2xl bg-${item.color}-500/10 flex items-center justify-center text-${item.color}-600 group-hover:scale-110 group-hover:bg-${item.color}-600 group-hover:text-white transition-all duration-500 shadow-sm shrink-0`}>
                                            <item.icon size={28} />
                                        </div>
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-2">
                                                <span className={`text-[10px] font-black text-${item.color}-600 uppercase tracking-[0.2em]`}>{item.tag}</span>
                                                <div className={`h-[1px] flex-1 bg-${item.color}-600/10`} />
                                            </div>
                                            <h4 className="text-2xl font-black italic tracking-tighter text-gray-900 mb-2 leading-tight uppercase">{item.title}</h4>
                                            <p className="text-sm text-gray-400 font-medium leading-relaxed group-hover:text-gray-500 transition-colors">{item.desc}</p>
                                        </div>

                                        {/* Subtle background glow on hover */}
                                        <div className={`absolute inset-0 bg-gradient-to-br from-${item.color}-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-[2.5rem] -z-10`} />
                                    </motion.div>
                                ))}
                            </div>
                        </motion.div>
            ...
            {/* SECCIÓN GROWTH: El Motor de Crecimiento (REORDERED) */}
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid lg:grid-cols-2 gap-12 sm:gap-20 items-center">
                        <div className="text-left space-y-8">
                            ...
                            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-[1000] tracking-tightest leading-tight">
                                <span className="text-indigo-600">Presencia Digital.</span>
                            </h2>
                            <p className="text-lg sm:text-xl text-gray-500 font-medium mt-6 sm:mt-8 leading-relaxed max-w-xl mx-0">
                            ...
                            <div className="grid gap-6 mt-10 sm:mt-12">
                                {[
                                    { title: "Integración Ads (Google & Meta)", desc: "Conectamos tu clínica con las plataformas de anuncios más potentes para asegurar un flujo constante de nuevos pacientes.", tag: "Estrategia", icon: TrendingUp, color: "indigo" },
                                    { title: "Nutrición de Leads (Donna Marketing)", desc: "Donna responde instantáneamente a cada prospecto en Instagram y Facebook, convirtiendo interesados en citas reales.", tag: "Conversión", icon: Target, color: "emerald" },
                                    { title: "Reputación & Reseñas Digitales", desc: "Automatizamos la captura de testimonios positivos en Google para que tu marca destaque y genere máxima confianza.", tag: "Marca", icon: Zap, color: "amber" }
                                ].map((item, i) => (
                                    <motion.div
                                        key={i}
                                        whileHover={{ x: 10, scale: 1.02 }}
                                        className="group relative flex gap-6 p-7 rounded-[2rem] bg-gray-50/50 border border-transparent hover:bg-white hover:border-indigo-100/50 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.06)] transition-all duration-500 cursor-default"
                                    >
                                        <div className={`w-14 h-14 rounded-2xl bg-${item.color}-600/10 flex items-center justify-center text-${item.color}-600 group-hover:scale-110 group-hover:bg-${item.color}-600 group-hover:text-white transition-all duration-500 shadow-sm shrink-0`}>
                                            <item.icon size={26} />
                                        </div>
                                        <div className="flex-1">
                                        ...
                                        <div className={`absolute inset-0 bg-gradient-to-br from-${item.color}-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-[2rem] -z-10`} />
                                    </motion.div>
                                ))}
                            </div>      {/* MARKETING & GROWTH CTA BUTTON: PILL SHAPE & VIBRANT INDIGO */}
                            <motion.a
                                href="/growth"
                                whileHover={{ y: -3, scale: 1.01 }}
                                whileTap={{ scale: 0.99 }}
            ...
            <section className="py-20 sm:py-48 px-4 sm:px-12 bg-[#0A0B14] text-white overflow-hidden relative">
                ...
                <div className="max-w-6xl mx-auto relative z-10">
                    <div className="text-left mb-16 sm:mb-24 space-y-8">
                        <div className="w-full flex justify-center lg:justify-start mb-8">
                            <div className="flex sm:inline-flex items-center justify-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-white/5 border border-white/10 text-indigo-400 text-[clamp(9px,2.5vw,10px)] font-bold uppercase tracking-[0.1em] whitespace-nowrap w-full sm:w-auto">
                                <TrendingUp size={10} className="w-[14px] h-[14px]" /> POR QUÉ ELEGIR NEUROV
                            </div>
                        </div>
                        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-[1000] tracking-tightest leading-tight text-white">¿Por qué NeuroV?</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:gap-4">
                        {[
                            ...
                            { f: 'Seguridad & Normativa', n: 'Ley 20.584 / 19.628', t: 'Manual / Básico', m: 'Ninguna', icon: ShieldCheck, desc: 'Todo bajo la ley chilena.' },
                            ...
                            { f: 'Marketing & Apoyo', n: 'Ayuda en Redes y Web', t: 'Posteos Básicos', m: 'Referidos Manuales', icon: TrendingUp, desc: 'Tu consulta siempre visible.' },
                ...
                <div className="max-w-5xl mx-auto text-left relative z-10 space-y-8">
                    ...
                    >
                        ...
                        <p className="text-gray-400 text-xl md:text-2xl font-medium mb-16 max-w-2xl mx-0 leading-relaxed">
                            Nuestro equipo te ayudará a organizar tu <span className="text-white font-bold">Gestión con NeuroV</span> en 30 minutos.
                        </p>
